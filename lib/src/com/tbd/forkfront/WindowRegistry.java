 ...
 * This class is not thread-safe and must be accessed only from the main thread.
 */
public final class WindowRegistry {
    ...
    public void forEach(Consumer<NH_Window> f) {
        checkMainThread();
        // Use a snapshot to avoid ConcurrentModificationException if windows are added/removed during iteration.
        // NH_State.setContext uses this to propagate Activity context.
