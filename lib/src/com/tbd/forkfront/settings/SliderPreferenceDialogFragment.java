...
public class SliderPreferenceDialogFragment extends PreferenceDialogFragmentCompat
  ...
  protected View onCreateDialogView(android.content.Context context) {
    ...
    mValueText.setTextSize(
        ...
        context.getResources().getDimensionPixelSize(R.dimen.text_size_xlarge));
    mValueText.setTextAppearance(
