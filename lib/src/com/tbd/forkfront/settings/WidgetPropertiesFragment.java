...
public class WidgetPropertiesFragment extends DialogFragment {
  ...
  public static WidgetPropertiesFragment newInstance(
      String currentLabel,
      boolean isButton,
      boolean isCommandPalette,
      boolean isHorizontal,
      int opacity,
      boolean showFontSize,
      int fontSize,
      int rows,
      int columns,
      String category,
      boolean contextualOnly,
      java.util.Set<String> pinnedCommands,
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    if (mIsCommandPalette) {
      ...
      switchOrientation.setOnCheckedChangeListener(
    ...
    // Opacity slider
    com.google.android.material.slider.Slider opacitySlider =
        view.findViewById(R.id.opacity_slider);
    ...
    opacitySlider.addOnChangeListener(
        (slider, value, fromUser) -> {
          ...
          opacityValue.setText(
              String.format(Locale.ROOT, "%d%%", (int) ((opacity / 255.0f) * 100)));
          if (mListener != null) {
    ...
    com.google.android.material.slider.Slider fontSizeSlider =
        view.findViewById(R.id.font_size_slider);
    ...
    if (mShowFontSize) {
      ...
      fontSizeSlider.addOnChangeListener(
          (slider, value, fromUser) -> {
            int size = (int) value;
    ...
    if (mIsCommandPalette) {
      ...
      if (mIsHorizontal) {
        ...
        rowsSlider.addOnChangeListener(
            (slider, value, fromUser) -> {
              int rows = (int) value;
        ...
        com.google.android.material.slider.Slider columnsSlider =
            view.findViewById(R.id.columns_slider);
        ...
        columnsSlider.addOnChangeListener(
            (slider, value, fromUser) -> {
      ...
      switchContextualOnly.setOnCheckedChangeListener(
          (buttonView, isChecked) -> {
            if (mListener != null) {
      ...
      com.google.android.material.button.MaterialButton btnPinCommands =
          view.findViewById(R.id.btn_pin_commands);
      btnPinCommands.setOnClickListener(
          v -> {
            PinCommandsFragment pinFragment = PinCommandsFragment.newInstance(mPinnedCommands);
            pinFragment.setOnPinsChangedListener(
                new PinCommandsFragment.OnPinsChangedListener() {
                  @Override
