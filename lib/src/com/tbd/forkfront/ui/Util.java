...
public class Util {
  ...
  public static View inflate(Context context, int layoutId, View parent) {
    View v = inflate(context, layoutId);
    ((ViewGroup) parent).addView(v);
    return v;
  }

  public static View inflate(AppCompatActivity context, int layoutId, int parentId) {
    View v = inflate(context, layoutId);
  ...
  /**
   * Copies bytes from the input stream to the output stream. The caller is responsible for closing
   * both streams.
   */
