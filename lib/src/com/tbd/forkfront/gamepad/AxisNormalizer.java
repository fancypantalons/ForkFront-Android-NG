...
/**
 * Converts analog axis events (triggers, HAT, sticks) into synthetic button press/release
 * events using threshold detection and hysteresis.
 */
public class AxisNormalizer {
    ...
    private void processTriggers(MotionEvent ev, EventSink sink) {
        ...
        boolean ltNow = lt >= TRIGGER_PRESS_THRESHOLD ||
                        (mLTriggerDown && lt > TRIGGER_RELEASE_THRESHOLD);
        ...
        boolean rtNow = rt >= TRIGGER_PRESS_THRESHOLD ||
                        (mRTriggerDown && rt > TRIGGER_RELEASE_THRESHOLD);
    ...
    private static int lStickOctantToPseudo(int octant) {
        switch (octant) {
            case 0: return ButtonId.LSTICK_UP_PSEUDO;
            case 1: return ButtonId.LSTICK_UR_PSEUDO;
            case 2: return ButtonId.LSTICK_RIGHT_PSEUDO;
            case 3: return ButtonId.LSTICK_DR_PSEUDO;
            case 4: return ButtonId.LSTICK_DOWN_PSEUDO;
            case 5: return ButtonId.LSTICK_DL_PSEUDO;
            case 6: return ButtonId.LSTICK_LEFT_PSEUDO;
            case 7: return ButtonId.LSTICK_UL_PSEUDO;
            default: return ButtonId.LSTICK_UP_PSEUDO;
        }
    }
    ...
    public static char pseudoToNhDir(int pseudoCode) {
        switch (pseudoCode) {
            case ButtonId.LSTICK_UP_PSEUDO:    return 'k';
            case ButtonId.LSTICK_DOWN_PSEUDO:  return 'j';
            case ButtonId.LSTICK_LEFT_PSEUDO:  return 'h';
            case ButtonId.LSTICK_RIGHT_PSEUDO: return 'l';
            case ButtonId.LSTICK_UL_PSEUDO:    return 'y';
            case ButtonId.LSTICK_UR_PSEUDO:    return 'u';
            case ButtonId.LSTICK_DL_PSEUDO:    return 'b';
            case ButtonId.LSTICK_DR_PSEUDO:    return 'n';
            default: return 0;
        }
    }
    ...
    public static int hatPseudoToDpad(int pseudo) {
        switch (pseudo) {
            case ButtonId.AXIS_HAT_LEFT_PSEUDO:  return android.view.KeyEvent.KEYCODE_DPAD_LEFT;
            case ButtonId.AXIS_HAT_RIGHT_PSEUDO: return android.view.KeyEvent.KEYCODE_DPAD_RIGHT;
            case ButtonId.AXIS_HAT_UP_PSEUDO:    return android.view.KeyEvent.KEYCODE_DPAD_UP;
            case ButtonId.AXIS_HAT_DOWN_PSEUDO:  return android.view.KeyEvent.KEYCODE_DPAD_DOWN;
            default: return -1;
        }
    }
