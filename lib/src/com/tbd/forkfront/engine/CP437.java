...
public class CP437 implements ByteDecoder {
  ...
  public String decode(byte[] bytes) {
    ...
    for (byte b : bytes) builder.append(UNICODE[b & 0xff]);
  ...
  private static final char[] UNICODE =
      new char[] {
        0x00A0, 0x263A, 0x263B, 0x2665, 0x2666, 0x2663, 0x2660, 0x2022, 0x25D8, 0x25CB, 0x25D9,
            0x2660, 0x2661, 0x266A, 0x266B, 0x2609,
        0x25BA, 0x25C4, 0x2195, 0x203C, 0x00B6, 0x00A7, 0x25AC, 0x2607, 0x2191, 0x2193, 0x2192,
        ...
        0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007A,
            0x007B, 0x007C, 0x007D, 0x007E, 0x2206,
        ...
        0x00C9, 0x00E6, 0x00C6, 0x00F4, 0x00F6, 0x00F2, 0x00FB, 0x00F9, 0x00FF, 0x00D6, 0x00DC,
            0x00A2, 0x00A3, 0x00A5, 0x20A3, 0x0192,
        ...
        0x03B1, 0x00DF, 0x0393, 0x03C0, 0x03A3, 0x03C3, 0x00B5, 0x03C4, 0x03A6, 0x0398, 0x03A9,
            0x03B4, 0x221E, 0x03C6, 0x25A0, 0x002B,
