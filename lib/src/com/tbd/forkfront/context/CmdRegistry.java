...
public class CmdRegistry {
  ...
  public static class CmdInfo {
    ...
    /**
     * Returns the command string with control characters converted to caret notation. Printable
     * commands are returned as-is.
     */
  ...
  private static final Set<String> HIDDEN_FROM_PALETTE =
      Collections.unmodifiableSet(
          new HashSet<>(
              Arrays.asList("y", "k", "u", "h", "l", "b", "j", "n", "S", "#quit", "#version")));
  ...
  static {
    ...
    add(
        ...
        "Move to a square without picking up items",
        Category.COMBAT);
  ...
  /**
   * Returns true if the command should appear in the command palette widget. Filters out
   * directional movement (covered by d-pad), save/quit (covered by sidebar), and version
   * (non-gameplay).
   */
