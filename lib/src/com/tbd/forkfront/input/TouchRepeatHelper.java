 ...
 *
 * <p>Mirrors the repeat logic from GamepadDispatcher so that touch-based widgets and the gamepad
 * behave identically: - 300 ms initial delay - 100 ms repeat interval
 */
