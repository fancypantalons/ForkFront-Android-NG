...
/**
 * A widget that displays a minimap overview of the entire dungeon. Shows player position, pets, and
 * the current viewport outline.
 */
public class MinimapWidget extends ControlWidget implements NHW_Map.MapUpdateListener {
  ...
  public MinimapWidget(Context context, NHW_Map mapWindow, Tileset tileset) {
    ...
    mMinimapView.setViewportInfo(
        mapWindow.getViewOffset(), mapWindow.getScale(), mapWindow.getCanvasRect());
  }
    ...
    private void updateColors() {
      ...
      COLOR_UNEXPLORED =
          ThemeUtils.resolveColor(
              getContext(), R.attr.colorGameBackground, R.color.nh_game_background);
      COLOR_VIEWPORT =
          ThemeUtils.resolveColor(getContext(), R.attr.colorOnSurface, R.color.md_theme_onSurface);
      COLOR_BORDER =
          ThemeUtils.resolveColor(getContext(), R.attr.colorOutline, R.color.md_theme_outline);
