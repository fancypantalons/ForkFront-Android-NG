...
public class CharacterAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    if (viewType == TYPE_CHARACTER) {
      View v =
          LayoutInflater.from(parent.getContext()).inflate(R.layout.row_character, parent, false);
      return new CharacterViewHolder(v);
    } else {
      View v =
          LayoutInflater.from(parent.getContext())
              .inflate(R.layout.row_new_character, parent, false);
  ...
  class NewCharacterViewHolder extends RecyclerView.ViewHolder {
    NewCharacterViewHolder(View itemView) {
      super(itemView);
      itemView
          .findViewById(R.id.new_character_row_root)
          .setOnClickListener(v -> listener.onNewCharacterRequested());
    }
  }
}
